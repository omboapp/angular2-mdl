...
// Dgeni packages that the Angular Material Design Lite docs package depends on.
...
apiDocsPackage.config(function(tsHost: Host) {
  ...
  // various files in the Angular Material Design Lite project where the first node of a source file is exported and
