 ...
 *
 * ```
 * warn:    Unresolved TypeScript symbol(s): _MatToolbarMixinBase - doc "mdl/toolbar/MatToolbar"
 *    (class)  - from file "mdl/toolbar/toolbar.ts" - starting at line 37, ending at line 98
 * ```
 *
