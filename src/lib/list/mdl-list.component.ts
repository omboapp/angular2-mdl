...
{
	private _lines: null | number = 1;
	@Input() get lines() { return this._lines; }
...
{
	constructor(
		@Optional() private mdlListItemComponent: MdlListItemComponent
	) {}
...
{
	constructor(
		@Optional() private mdlListItemComponent: MdlListItemSecondaryContentComponent
	) {}
