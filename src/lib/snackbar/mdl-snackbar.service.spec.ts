...
import { MdlSnackbarService, MdlSnackbarModule } from './mdl-snackbar.service';
import { MdlDialogOutletModule } from '@angular/mdl/dialog-outlet';
import { MdlDialogOutletService } from '@angular/mdl/dialog-outlet/mdl-dialog-outlet.service';
...
describe('Service: MdlSnackbar', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      imports: [MdlSnackbarModule, MdlDialogOutletModule],
      providers: []
    });
  }));
