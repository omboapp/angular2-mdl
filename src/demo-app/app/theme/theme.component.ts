...
export class ThemeDemo extends AbstractDemoComponent implements OnInit
{
	...
	public selectedAccentColor: any = this.mapToColorObject(AMBER, MD_COLORS.indexOf(AMBER));
	...
	get cdnLink()
	{
		...
		/* tslint:disable */
		let cdnLinkElem = `<link rel="stylesheet" href="${this.stylesheetUrl}" />`;
		/* tslint:enable */
	...
	private mapToColorObject(color: any, i: any)
	{
		return {
			name: color,
	...
	private normaliseColorName(color: any)
	{
		if (!color) {
			return '';
		}
	...
	public selectPrimaryColor(color: any)
	{
	...
	public selectAccentColor(color: any)
	{
	...
	private updateStylesheet()
	{
		...
		this.styleElement.href = this.stylesheetUrl;
	}
}
