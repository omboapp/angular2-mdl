...
/**
 * @deprecated custom dialogs no longer need to implement this interface
 */
...
export interface IMdlDialogConfiguration
{
	 ...
	 */
	openFrom?: MdlButtonComponent | MouseEvent | IOpenCloseRect | undefined;

	/**
	 *  MdlButtonComponent or mouse event  the dialog close animation should end.
	 */
...
/**
 * The simple dialog. Easy to use - doesn't need a special component.
 */
