...
} from '@angular/mdl/dialog-outlet';
import { MdlButtonComponent, MdlButtonModule } from '@angular/mdl/button';
import { MdlDialogModule, MdlDialogReference } from './index';
import { MdlDialogService, MdlSimpleDialogComponent } from './dialog';
...
describe('Service: MdlDialog', () => {
  ...
  beforeEach(async(inject([MdlDialogService, MdlDialogOutletService, DOCUMENT],
    function (service: MdlDialogService, mdlDialogOutletService_: MdlDialogOutletService, doc_: any) {
  ...
  it('should emit an event when the first dialog instance is opened', async(() => {
    ...
    mdlDialogService.onDialogsOpenChanged.subscribe( ( dialogsOpen: any ) => {
